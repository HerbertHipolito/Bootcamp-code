...
Original file is located at
    https://colab.research.google.com/drive/1GBAXPqmTR2X2_fp-I9XSrDC4rXLGpFWt
...
directory_path_malignos = './cropped_and_treated_100_nods_maligno/'
directory_path_benignos = './cropped_and_treated_100_nods_benigno/'
...
array_of_images_benignos.pop(0)
...
for key in architectures:
  ...
  with open(str(key)+'.txt', 'w') as convert_file:
     convert_file.write(json.dumps(results[key]))
     
"""####Using data aumentation and restore_best_weight=false

#### using restore_best_weight=true
"""
...
with open('groupedResults.txt', 'w') as convert_file:
